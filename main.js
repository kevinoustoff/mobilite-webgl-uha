...
const mapCustom = new MapCustom(accessToken, 'map', 'mapbox://styles/mapbox/light-v11', centerNode.toArray(), 18, 70, -17.6,15);

const numCubes = 100; // Number of moving cubes
